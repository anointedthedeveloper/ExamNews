...
import { TrendingUp, Info, School, Building2, GraduationCap, ExternalLink } from "lucide-react";
          ...
          <div className="main-content">
            ...
            <div className="card" style={{marginBottom: '32px'}}>
              ...
              <div style={{marginBottom: '24px'}}>
                <div style={{display: 'grid', gap: '8px'}}>
                  ...
                  <div style={{display: 'flex', justifyContent: 'space-between', padding: '12px', background: '#f9fafb', borderRadius: '4px'}}>
                    <span>University of Nigeria, Nsukka (UNN)</span>
                    <span style={{fontWeight: 600}}>180+</span>
                  </div>
                </div>
              </div>
              ...
              <ul style={{marginLeft: '24px'}}>
                ...
                <li style={{marginBottom: '8px'}}><strong>Mass Communication:</strong> 210 – 250</li>
              </ul>
            </div>
            ...
            <div className="card" style={{marginBottom: '32px'}}>
              ...
              <div style={{display: 'grid', gap: '8px', marginBottom: '16px'}}>
                ...
                <div style={{display: 'flex', justifyContent: 'space-between', padding: '12px', background: '#f9fafb', borderRadius: '4px'}}>
                  <span>Ebonyi State University (EBSU)</span>
                  <span style={{fontWeight: 600}}>140</span>
                </div>
              </div>
            </div>
            ...
            <div className="card" style={{marginBottom: '32px'}}>
              ...
              <ul style={{marginLeft: '24px', marginBottom: '16px'}}>
                ...
                <li style={{marginBottom: '8px'}}><strong>Kaduna Polytechnic:</strong> 120</li>
              ...
              <p style={{marginBottom: '16px'}}>All Colleges of Education accept the national minimum of 100 for NCE programs.</p>
            ...
            <div className="card" style={{marginBottom: '32px'}}>
              ...
              <div>
                <h3 style={{fontSize: '1.125rem', fontWeight: 600, marginBottom: '8px'}}>How important is Post-UTME?</h3>
                <p style={{margin: 0}}>Extremely important. Your final admission aggregate combines JAMB, Post-UTME, and O'Level grades. A strong Post-UTME can compensate for a lower JAMB score.</p>
              </div>
            </div>
          </div>
          ...
          <aside className="sidebar">
            <div className="sidebar-card" style={{background: '#eff6ff', borderColor: '#0A3D91'}}>
              ...
              <ul className="sidebar-links">
                ...
                <li><Link to="/jamb-registration"><span>Registration Guide</span><ExternalLink size={14}/></Link></li>
                ...
                <li><Link to="/admission-status"><span>Check Admission</span><ExternalLink size={14}/></Link></li>
              </ul>
            </div>
